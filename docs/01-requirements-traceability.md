...
| 1.3 | Consider available manpower | NEW | `planning_engine._get_manpower_factor()` derates capacity by roster shortfall against `fmes.operator.allocation`; hook added Phase 3, live once Phase 8's roster model exists | 3 ✅, 8 ✅ |
